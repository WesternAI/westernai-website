// i stole and had to fix so much of this fucking code just so that it could work in react 🤦‍♀️ 

import {RGBtoHEX, getInverseHex} from "./RGBtoHEX";
import makeElementDraggable from "./makeDraggable";
        ...
        for ( let i = 0; i < particles.length; i++) {
            ...
            if (p.x >= 0 && p.x < canvas_width && p.y >= 0 && p.y < canvas_height) {
                ...
                */
                ...
                // const randNum = getRandomNumber(1, 3)

                // switch(randNum){
                //     case 1:
                //         // #d98cf5,#2b20f8,#31a2fa
                //         ctx.strokeStyle = "#d98cf5";
                //         break;
                //     case 2:
                //         ctx.strokeStyle = "#2b20f8";
                //         break;
                //     case 3:
                //         ctx.strokeStyle = "#31a2fa";
                //         break;
                // }
    ...
    */
    function draw() {
        ...
        */
        ...
        const bg_colour = getInverseHex(RGBtoHEX(window.getComputedStyle(document.body).getPropertyValue('background-color')))
...
}; //Passes "window" into the self-invoking function.


export default initializeFluid;